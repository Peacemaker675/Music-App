...
let songs=['Attention','Chahun Main Ya Naa','Suzume','Die For You','Greenback Boogie','Gulabi Aankhen','horimiya op 1','horimiya op 2','Kalyug vs Bhagwaan','Love You Still','Shinunoga E-Wa','Venom'];
let currentIndex=0;
...
forward.addEventListener("click", () => { if(currentIndex==songs.length-1){
